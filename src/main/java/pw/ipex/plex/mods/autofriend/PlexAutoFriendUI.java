...
public class PlexAutoFriendUI extends PlexUIBase {
	...
	public void uiAddButtons(PlexUIModMenuScreen ui) {
		...
		ui.addElement(new PlexUISlider(this, 7, pane1Pos + 5, top + 46, paneSize - 10, 20, (float) (PlexCore.getSharedValue("autoGG_delay").doubleValue / (PlexAutoFriendMod.MAX_DELAY - PlexAutoFriendMod.MIN_DELAY)), delayDisplayString()));
	...
	public void uiSliderInteracted(PlexUISlider slider) {
		if (slider.id == 7) {
			PlexCore.getSharedValue("autoGG_delay").set((double) (PlexAutoFriendMod.MIN_DELAY + (slider.sliderValue * (PlexAutoFriendMod.MAX_DELAY - PlexAutoFriendMod.MIN_DELAY))));
