...
public class PlexOldCommandQueueCommand {
	public PlexOldCommandQueue parentQueue;
	...
	public PlexOldCommandQueueDelaySet delaySet;
	...
	public PlexOldCommandQueueCommand(String group, String command) {
		this.group = group;
		this.command = command;
	}
	
	public PlexOldCommandQueueCommand(String group, String command, Long delay) {
		this.group = group;
		this.command = command;
