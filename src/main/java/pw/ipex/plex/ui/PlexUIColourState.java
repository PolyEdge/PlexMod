...
public class PlexUIColourState {
	...
	public Integer colourBetweenStates(String colour, PlexUIColourState state1, PlexUIColourState state2, Float between) {
		return this.colourBetweenStates(colour, state1, state2, between, null);
	}
	
	public Integer colourBetweenStates(String colour, PlexUIColourState state1, PlexUIColourState state2, Float between, Integer def) {
		between = between == null ? 1.0F : PlexCoreUtils.floatRange(between, 0.0F, 1.0F);
	...
	public PlexUIColourState colourStateBetween(PlexUIColourState state1, PlexUIColourState state2, Float between) {
		between = between == null ? 1.0F : PlexCoreUtils.floatRange(between, 0.0F, 1.0F);
		...
		PlexUIColourState newState = new PlexUIColourState();
